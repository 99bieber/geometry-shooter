...
public class EnemiesSpawn_Hard : MonoBehaviour
{
    float timer = 0.0f;
    float randtime;
    ...
    void Update()
    {
        ...
        if(timer > randtime)
        {
            ...
            ship.GetComponent<Rigidbody2D>().velocity = dir * Random.Range(300f, 500f) * Time.deltaTime;
            randtime = Random.Range(0.1f, 0.4f);
            timer = 0.0f;
        }
